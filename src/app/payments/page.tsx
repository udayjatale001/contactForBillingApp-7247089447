...
function PaymentsPage() {
  ...
  const handleWhatsAppReminder = (customer: Customer, paidAmount?: number, remainingDue?: number, date?: Date) => {
    ...
    if (paidAmount && remainingDue !== undefined && date) {
        ...
        // This is a payment reminder message
                ...
                >
                    ...
                    <div className="w-full sm:w-auto flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center">
                            <Button variant="ghost" size="icon" onClick={(e) => { e.stopPropagation(); handleWhatsAppReminder(customer);}}>
