...
export default function LabourerPage() {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${selectedIds.size} records have been successfully removed.`
      });
      setSelectedIds(new Set());
    } catch (error) {
  ...
  return (
    <>
      ...
      <AlertDialog
        open={!!recordToDelete}
        onOpenChange={() => setRecordToDelete(undefined)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the {selectedIds.size} selected records.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
