...
// A separate component for the printable bill to ensure no extra data is included.
const PrintableBill = ({ bill, t }: { bill: Bill; t: (key: any, ...args: any[]) => string }) => (
    <>
        {/* Header */}
...
export function BillSummaryDialog({ bill, open, onOpenChange, onSave, isSaving, isViewing = false, onDelete }: BillSummaryDialogProps) {
  ...
  return (
    ...
    <div className="hidden" id="printable-area">
        <div id="bill-receipt" className="p-4 bg-white text-black">
            <PrintableBill bill={bill} t={t} />
        </div>
    </div>
